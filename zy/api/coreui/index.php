...
<body class="app header-fixed sidebar-fixed aside-menu-fixed aside-menu-hidden">
    ...
    <div class="app-body">
        ...
        <!-- Main content -->
        <main class="main">
            <?php if(isset($_POST['order'])) $order=$_POST['order'];
                   else
            $order='asc';
            ...
            <ol class="breadcrumb">
                ...
                <li      class="breadcrumb-item "   >
                    <input type="radio" name="order" id="radio" value="asc" <?php if ($order=='asc') {?>checked="checked" <?php }?> />                  asc
                    &nbsp;&nbsp;&nbsp;&nbsp;  <input type="radio" name="order" id="radio1" value="desc"   <?php if ($order=='desc') {?>checked="checked" <?php }?>  />
                  desc
                </li>    <li class="breadcrumb-item">  &nbsp;&nbsp;&nbsp;&nbsp;   &nbsp;  <button type="submit" class="  btn-primary">contact</button>  </li>
               <li      class="breadcrumb-item    ">         &nbsp;&nbsp;&nbsp;&nbsp;<a href="add.php" >add</a></li>
                <li      class="breadcrumb-item    ">         &nbsp;&nbsp;&nbsp;&nbsp;<a href="loginout.php" >login out </a></li>
                                    ...
                                    <table class="table table-hover table-outline mb-0 hidden-sm-down">
                                        <thead class="thead-default">
                                            <tr>
                                                ...
                                                <th class="text-center">contact_id</th>
                                                <th>contact_first</th>
                                                <th class="text-center">contact_last</th>
                                                <th>contact_email</th>
                                                <th>edit</th>
                                                <th>delete</th>
                                            </tr>
                                        ...
                                        $sql="select * from mad9023_contacts order by  contact_id ".$order; 
                                        ...
                                        <tr>
                                               ...
                                               <?php echo $row['contact_id'];?>
                                                ...
                                                <td class="text-center">
                                                    <?php echo $row['contact_first'];?>
                                                </td>
                                                <td class="text-center">
                                                    <?php echo $row['contact_last'];?>
                                                ...
                                                <td>
                                                    ...
                                                    <strong><a href="edit.php?id=<?php echo $row['contact_id'];?> " >edit</a></strong>
                                                </td>
                                                <td>

                                                    <strong><a href="../v1/delete.php?id=<?php echo $row['contact_id'];?>"  onclick="return confirm('确定要删除吗？')">delete</a> </strong>
                                                </td>
                                            </tr>
<?php }?>
