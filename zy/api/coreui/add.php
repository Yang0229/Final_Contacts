        ...
        <main class="main">
            ...
            <div class="container-fluid">
                <div class="animated fadeIn">
                    <form  action="../v1/add_save.php" method="post">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <div class="input-group">
                                            <input id="appendedInputButton" class="form-control" size="16" type="text" name="contact_first">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <div class="input-group">
                                            <input id="appendedInputButton" class="form-control" size="16"name="contact_last" type="text">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <div class="input-group">
                                            <input id="appendedInputButton" class="form-control" size="16" name="contact_email" type="text">
                                        </div>
                                    </div>
                                </div>
