...
<form  action="../v1/edit_save.php" method="post">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                $contact_last='';
                                if(!empty($id))
                                {$result=$pdo->query ("select * from mad9023_contacts where contact_id=".$id." limit 1");
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="form-control-label" for="appendedInputButton">contact_first</label>
                                    <div class="controls">
                                        <div class="input-group">
                                            <input id="appendedInputButton" class="form-control" size="16" type="text" name="contact_first"  value="<?php echo $contact_first;?>">
                                        </div>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label class="form-control-label" for="appendedInputButton">contact_last</label>
                                    <div class="controls">
                                        <div class="input-group">
                                            <input id="appendedInputButton" class="form-control" size="16" type="text" name="contact_last" value="<?php echo $contact_last;?>">
                                        </div>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label class="form-control-label" for="appendedInputButton">contact_email</label>
                                    <div class="controls">
                                        <div class="input-group">
                                            <input id="appendedInputButton" class="form-control" size="16" type="text"  name="contact_email" value="<?php echo $contact_email;?>">
                                        </div>
                                    </div>
                                </div>
